                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <select class="form-control" id="exampleFormControlSelect1" name="status_pembayaran">
                                        <option <?php if ($b['status_pembayaran'] == "Sudah Bayar DP") { ?>selected<?php } ?>>Lunas</option>
                                        <option <?php if ($b['status_pembayaran'] == "Sudah Bayar DP") { ?>selected<?php } ?>>Sudah Bayar DP</option>
                                        <option value="Belum Bayar DP" <?php if ($b['status_pembayaran'] == "Belum Bayar DP") { ?>selected<?php } ?>>Belum Bayar DP/DP Kurang</option>
                                    </select>
                                </div>
                            </div>
